...
export function ItinerariesPage() {
  ...
  useEffect(() => {
    ...
    const fetchItineraries = async () => {
      ...
      //console.log('Using token for itineraries:', token); 
      ...
      try {
        ...
        const response = await fetch('http://127.0.0.1:5000/get_my_itineraries', {
          method: 'POST',
          headers: {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-6">
          {parsedItineraries.map((itinerary : Itinerary) => (
            <Link key={itinerary.Itineraryid} to={`/itinerary/${itinerary.Itineraryid}`}>
              <motion.div
